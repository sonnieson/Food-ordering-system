				...
				<div class="card-body">
					<div class="container-fluid">
						...
						<div class='row'>
							...
							<div class="col-md-6 lh-1">
								<h3>Order Summery</h3>
								<p class="mb-1"><strong>Items</strong>: Ksh<?php echo $orderTotal; ?></p>
								<p class="mb-1"><strong>Delivery</strong>: Ksh0</p>
								<p class="mb-1"><strong>Total</strong>: Ksh<?php echo $orderTotal; ?></p>
								<p class="mb-1"><strong>Order Total</strong>: Ksh<?php echo $orderTotal; ?></p>
							</div>
						</div>
					</div>
				</div>
				<div class="card-footer py-1">
					<div class="row justify-content-center">
						<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
							<div class="d-grid">
								<a href="process_order.php?order=<?php echo $orderNumber;?>"  class="btn btn-warning rounded-0">Place Your Order</a>
							</div>
						</div>
					</div>
				</div>
