	...
	<div class="container-fluid">		
		...
		?>      
			...
			?>
				...
				<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>" onclick="if(confirm('Are you sure you want to remove this item from the cart?') === false) { event.preventDefault() }"><span class="text-danger text-decoration-none">Remove</span></a></td>
				</tr>
				<?php 
